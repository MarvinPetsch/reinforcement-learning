...
BATCH_SIZE = 128
GAMMA = 0.99  # The lower, the less important are uncertain rewards in the far future
EPSILON_START = 0.9  # The higher, the more probable it is to take actions randomly, enhancing exploration
...
for episode in range(num_episodes):
    ...
    match episode:
        case 999:
            torch.save(policy_net.state_dict(), 'non-lidar-models/FlappyBirdModel-Episode1000.pt')
        case 1999:
            torch.save(policy_net.state_dict(), 'non-lidar-models/FlappyBirdModel-Episode2000.pt')
        case 2999:
            torch.save(policy_net.state_dict(), 'non-lidar-models/FlappyBirdModel-Episode3000.pt')
        case 3999:
            torch.save(policy_net.state_dict(), 'non-lidar-models/FlappyBirdModel-Episode4000.pt')
        case 4999:
            torch.save(policy_net.state_dict(), 'non-lidar-models/FlappyBirdModel-Episode5000.pt')
        case 5999:
            torch.save(policy_net.state_dict(), 'non-lidar-models/FlappyBirdModel-Episode6000.pt')
        case 699:
            torch.save(policy_net.state_dict(), 'non-lidar-models/FlappyBirdModel-Episode7000.pt')
        case 7999:
            torch.save(policy_net.state_dict(), 'non-lidar-models/FlappyBirdModel-Episode8000.pt')
        case 8999:
            torch.save(policy_net.state_dict(), 'non-lidar-models/FlappyBirdModel-Episode9000.pt')
        case 9999:
            torch.save(policy_net.state_dict(), 'non-lidar-models/FlappyBirdModel-Episode10000.pt')
        case 19999:
            torch.save(policy_net.state_dict(), 'non-lidar-models/FlappyBirdModel-Episode20000.pt')
        case 29999:
            torch.save(policy_net.state_dict(), 'non-lidar-models/FlappyBirdModel-Episode30000.pt')
        case 39999:
            torch.save(policy_net.state_dict(), 'non-lidar-models/FlappyBirdModel-Episode40000.pt')
        case 49999:
            torch.save(policy_net.state_dict(), 'non-lidar-models/FlappyBirdModel-Episode50000.pt')
    '''
